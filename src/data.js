...
export const COURSES = [
  ...
  { name: "Monday - Tidewater", day: 2, ctpHoles: [9, 17], par3Holes: [3, 9, 12, 17], holes: [
    {number:1,par:5,hcp:13},{number:2,par:4,hcp:11},{number:3,par:3,hcp:9},{number:4,par:4,hcp:1},{number:5,par:4,hcp:3},{number:6,par:4,hcp:7},{number:7,par:4,hcp:17},{number:8,par:5,hcp:15},{number:9,par:3,hcp:5},
  ...
  { name: "Tuesday - Plantation", day: 3, ctpHoles: [7, 17], par3Holes: [3, 7, 13, 17], holes: [
    {number:1,par:5,hcp:15},{number:2,par:4,hcp:1},{number:3,par:3,hcp:11},{number:4,par:5,hcp:13},{number:5,par:4,hcp:5},{number:6,par:4,hcp:7},{number:7,par:3,hcp:17},{number:8,par:4,hcp:3},{number:9,par:4,hcp:9},
  ...
  { name: "Wednesday - Prestwick", day: 4, ctpHoles: [8, 16], par3Holes: [5, 8, 13, 16], holes: [
    {number:1,par:4,hcp:9},{number:2,par:4,hcp:1},{number:3,par:4,hcp:5},{number:4,par:4,hcp:7},{number:5,par:3,hcp:11},{number:6,par:5,hcp:15},{number:7,par:4,hcp:13},{number:8,par:3,hcp:17},{number:9,par:5,hcp:3},
